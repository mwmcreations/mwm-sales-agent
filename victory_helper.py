...
- An event (a tournament, a testing, a seminar, a party, a free class): energetic highlights of the same kind of event from the convention. Words on screen: the event name, the day and time, the place, bring your friends. End card: the event, the date. If they have given a day and a time, PROPOSE NOW with those on screen and leave out what they did not say (the place, a price) — do not hold a proposal for a missing place. If they gave no day or time at all, ask for them in ONE question — never invent them.
- Keep parents motivated / retention / why it is worth it: THEIR KIDS at the proud moments — a belt handed over, a board broken, a medal, a kid's face lighting up — plus the candlelight ceremony and a line someone said on camera about perseverance; slow, emotional. One parent reaction at most; a parent watches this to see their child, not other parents. Words on screen: one or two lines that speak to a parent. End card: the school's name and a warm line.
