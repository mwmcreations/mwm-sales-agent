...
LINGER = float(os.environ.get("VI_LINGER", "1500"))  # the daemon starts this in the background (21 Sep); it listens for 25 min, then the next pass starts a fresh one
