...
function mwm_rm_seed_zbrothers() {
	...
	$wpdb->insert( $actions, array(
		'client_id' => $client_id,
		'title'     => 'You have not used any of your 12 studio hours',
		'detail'    => 'They are included in your plan and they expire with your contract year. A studio day is the cheapest way to add a Z CAST episode or a batch of social films.',
		'due_date'  => '2026-11-14',
		'resolved'  => 0,
	) );
	$wpdb->insert( $actions, array(
